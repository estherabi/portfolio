            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <div class="col-12 color-gradiente">
                            <h2>ABM CLIENTES</h2>
                        </div>
                        <div class="col-12">
                            <p class="py-2 px-3">
                        ...
                        <div class="col-6 text-center">
                            <a href="#" class="btn-rojo p-2" target="_blank">Ver online</a>
                        </div>
                        <div class="col-6 col-6 offset-6 mb-20 text-center">
            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <div class="col-12">
                            <p class="py-2 px-3">
                                Sistema de gestión de clientes, productos, y ventas. Realizado en
                                HTML,CSS,PHP,MVC,
                                Boostrap, JS, Ajax, jQuery y MySQL de base de datos
                            </p>
                        </div>
                        <div class="col-6 text-center">
                            <a href="sistema/login" class="btn-rojo p-2" target="_blank">Ver online</a>
                        </div>
                        <div class="col-6 col-6 offset-6 mb-20 text-center">
                            <a href="#" class="link-rojo">Código fuente</a>
                        </div>
            ...
            <div class="col-12 col-sm-4 p-4">
                <div class="row border proyecto pb-5">
                    <div class="col-12 p-0">
                        ...
                        <div class="col-12">
                            <p class="py-2 px-3">
                                Proyecto Full Stack desarrollado en PHP,
                                Laravel,Javascript,jQuery,AJAX,HTML,CSS,
                        ...
                        <div class="col-6 offset-6 mb-20 text-center">
                            <a href="#" class="link-rojo">Código fuente</a>
                        </div>
                    </div>
                </div>
